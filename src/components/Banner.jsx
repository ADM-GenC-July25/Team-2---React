        ...
        `}
            ...
            <header style={bannerStyle}>
                ...
                <div style={logoStyle}>
                    ...
                    <div style={{ fontSize: '1.5em', fontWeight: 'bold', color: '#4ecdc4' }}>
                        COSMIC CUISINE
                    </div>
                </div>

                <h1 style={titleStyle}>
                    Galactic Flavors Await!
                </h1>
                <p style={subtitleStyle}>
                    Experience extraordinary dining from across the universe. From Martian delicacies to
                    Neptunian noodles, discover flavors that are truly out of this world.
                </p>
